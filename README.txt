...
So that you have the following directory tree:
  sites/all/modules/predis/predis.inc
  sites/all/modules/predis/predis/lib/Predis # Where the PHP code stands
...
file like any other backend:
  $conf['cache_backends'][] = 'sites/all/modules/predis/predis.inc';
